...
public class Java8Practice {
...

    {
        ...
        el.add(new Employee(111, "NIiya Brein", 32, "Female", "HR", 2011, 25000.0));
        el.add(new Employee(122, "Paul Niksui", 25, "Male", "Sales And Marketing", 2015, 18000.0));
        ...
        el.add(new Employee(155, "Jaisai Brein", 27, "Female", "HR", 2013, 22700.0));
        ...
        el.add(new Employee(188, "Niya Brein", 31, "Male", "Product Development", 2015, 18000.0));
        ...
        el.add(new Employee(222, "Nitin Joshi", 25, "Male", "Product Development", 2016, 18000.0));
        el.add(new Employee(233, "Jyothi Reddy", 27, "Female", "Account And Finance", 2013, 21300.0));
        el.add(new Employee(244, "Nicolus Den", 24, "Male", "Sales And Marketing", 2017, 18000.0));
        el.add(new Employee(255, "Ali Baig", 23, "Male", "Infrastructure", 2018, 12700.0));
        el.add(new Employee(266, "Sanvi Pandey", 26, "Female", "Product Development", 2015, 18000.0));
        el.add(new Employee(277, "Anuj Chettiar", 31, "Male", "Product Development", 2012, 35700.0));
//Sort The Employeee based on salary

      el.stream().sorted(Comparator.comparing(Employee::getSalary).thenComparing(Employee::getName)).forEach(
              x-> System.out.println(x.getName()+" "+x.getSalary())
      );
    }
}
